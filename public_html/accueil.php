...
<body class="home">
    ...
    <div class="page-content">     
        ...
        <section class="tech-and-testimonials" style="display:none">
            <div class="technologies">
                ...
                <div id="tech-tab-basic" class="tech-tab active">
                    ...
                    <div class="tech-description">
                        ...
                        <p>C# est un puissant langage de programmation orienté objet développé par Microsoft. Principalement utilisé pour créer des applications Windows, des applications Web avec ASP.NET et le développement de jeux avec Unity. C# combine la simplicité du C et la robustesse du C++ avec des fonctionnalités pour le développement moderne, notamment le typage fort et le garbage collection.</p>
                    </div>
                ...
                <div id="tech-tab-cms" class="tech-tab">
                    ...
                    <div class="tech-description">
                        <span class="h5">TailwindCSS</span>
                ...
                <div id="tech-tab-ops" class="tech-tab">
                    ...
                    <div class="tech-description">
                        <span class="h5">Gestion DNS</span>
                    ...
                    <div class="tech-description">
                        <span class="h5">RESTful API</span>
                    ...
                    <div class="tech-description">
                        <span class="h5">Passerelle de paiement en ligne (API)</span>
                        <p>Une API de passerelle de paiement facilite les transactions en ligne sécurisées en connectant un site Web de commerce électronique à un processeur de paiement. Il permet aux entreprises d'accepter des paiements par voie électronique, en gérant des tâches telles que l'autorisation de paiement, le traitement et le transfert de fonds. Cette intégration API permet des transactions financières transparentes et sécurisées, prenant en charge diverses méthodes de paiement et améliorant l'expérience utilisateur dans les transactions en ligne.</p>
                    </div>

                    <div class="tech-description">
                        <span class="h5">OAuth (Google, Facebook)</span>
                ...
                <div id="tech-tab-less" class="tech-tab">
                    ...
                    <div class="tech-description">
                        <span class="h5">Objective C</span>
                    ...
                    <div class="tech-description">
                        <span class="h5">Next JS</span>
                        <p>Next.js est un framework Web basé sur React qui simplifie le développement d'applications React. Il offre des fonctionnalités telles que le rendu côté serveur, le fractionnement automatique du code et le routage simplifié, améliorant les performances et l'optimisation du référencement. Next.js prend en charge un déploiement facile et offre une expérience de développement rationalisée pour créer des applications React modernes et rendues sur serveur.</p>
                    </div>
