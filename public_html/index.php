...
<body class="home">
    <div class="header-container">        
        <?php include('_parts/main-menu.php'); ?>
    </div>
    <div class="page-content">
        ...
        <section class="hero">
            <div>
                <p>Bienvenue sur le site web de André-Philippe Boulet, un programmeur-analyste qui développe des logiciels web et mobiles depuis plus de 15 ans</p>
            </div>
            <div>
            ...
            <div>
                <p>Développeur web - Disponible pour mandats à distance</p>
                <p>Pour un partenariat à long terme ou petits mandats ponctuels</p>
            </div>
        </section>
