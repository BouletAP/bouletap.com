...
// Carousel Feature Slide
    ...
    setTimeout(function() {
        owlmainslider.find('.to-animate').css('opacity', '1');
    }, 2000);
...
// VIDEO, AUDIO SCRIPT
    ...
    try {
        //GOOGLE MAP SCRIPT
        var map;
        var myLatLng = new google.maps.LatLng(45.207083, -72.748278)
        var myOptions = {
            zoom: 16,
            center: myLatLng,
        ...
        var marker = new google.maps.Marker({
            ...
            map: map,
            icon: 'https://bouletap.com/wp-content/themes/freelancer/medias/imgs/map-marker.png'
        });
        marker.getPosition();
