        ...
        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12"> 
          ...
          <div class="contact-detail">
            <div class="details">
              ...
              <div class="fc-contact-no"><i class="fa fa-phone"></i><a href="tel:+910000000000">+450-775-2905</a></div>
            </div>
            <div class="details address">
              <h4><?php _e("Freelance Web Developer", "bouletap"); ?></h4>
              <p><?php _e("Main office", "bouletap"); ?><br/>
                <?php _e("1655 Mullins St. Office 17", "bouletap"); ?><br/>
                <?php _e("Montreal", "bouletap"); ?>, QC<br/>
                H3K 1N3, Canada</p>
            </div>
