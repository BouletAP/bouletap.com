        ...
        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12"> 
          ...
          <div class="contact-detail">
            <div class="details">
              ...
              <div class="fc-contact-no"><i class="fa fa-phone"></i><a href="tel:+4507752905">+450-775-2905</a></div>
            </div>
            <div class="details address">
              ...
              <p><?php _e("Main office", "bouletap"); ?><br/>
                ...
                <p><strong><?php _e("Our main office is currently closed until further notice (COVID-19).", "bouletap"); ?> </strong><br><?php _e("We're still available to answer your question, emergency or new projet. Don't hesitate to contact us by phone or email.", "bouletap"); ?></p>
            </div>
