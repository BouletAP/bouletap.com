            ...
            <div class="page-admin">
                ...
                <div>
                    ...
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <div>Featured (ordre): <?php echo $form->getField('featured')->display(); ?></div>
                        <div><?php echo $form->getField('url')->display(); ?></div>
                        <div>1 si le site est mort: <?php echo $form->getField('site_mort')->display(); ?></div>
                        ...
                        <div class="flex-images">
                            ...
                            <div class="col-3">
                                <?php echo $form->getField('images_4')->display(); ?>
                                <?php echo $form->getField('images_4_desc')->display(); ?>
                            </div>
                        </div>
                        ...
                        <div>Date de lancement (Mois Annee)<?php echo $form->getField('date_publication')->display(); ?></div>
                        <div>Catégories: <?php echo $form->getField('type_projet')->display(); ?></div>
                        <div>Nom du client: <?php echo $form->getField('nom_client')->display(); ?></div>
                        
                        <div>Pastille: <?php echo $form->getField('pastille')->display(); ?></div>
                        <div>Langue: <?php echo $form->getField('langue')->display(); ?></div>

                        <div>1 si privé (admin only): <?php echo $form->getField('private')->display(); ?></div>
