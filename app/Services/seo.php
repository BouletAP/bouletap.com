    ...
    <div class="page-content">  
        ...
        <section class="hero">
            ...
            <div class="page-header">
                ...
                <h2>SEO et optimisation de vos réseaux sociaux</h2>     
                <p>Vos clients n'arrivent pas par magie sur votre site. L'optimisation de votre présence sur les moteurs de recherche, les entrées directes et les médias sociaux est cruciale pour votre croissance et mérite une attention particulière.</p>           
            </div>
        </section>
        ...
        <section class="presentation">
            ...
            <div class="details">
                <div class="sidebar">
                    ...
                    <ul>
                        <li><a href="/services/creation-site-internet">Création d'un site Internet</a></li>
